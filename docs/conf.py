...
# -*- coding: utf-8 -*-
#
# incor documentation build configuration file, created by
...
project = 'incor'
copyright = '2016, lakshmanaram, srivatsan-ramesh'
...
latex_documents = [
    (master_doc, 'incor.tex', 'incor Documentation',
     'lakshmanaram, srivatsan-ramesh', 'manual'),
]
